...
const en = {
  ...
  rbAlias: "SSH host alias", rbEmpty: "No explicit Host aliases found in ~/.ssh/config. Add a host using OpenSSH, then refresh.",
  ...
  rbCheck: "Check connection", rbChecked: "SSH connection verified", rbRefresh: "Refresh hosts", rbNext: "Continue", rbBack: "Back", rbClose: "Close",
  rbProxy: "Current local proxy", rbNoProxy: "The active proxy is unavailable. Select an available proxy on the home page.",
...
const zh: Labels = {
  ...
  rbCheck:"检查连接", rbChecked:"SSH 连接已验证", rbRefresh:"刷新主机", rbNext:"下一步", rbBack:"上一步", rbClose:"关闭", rbProxy:"当前本机代理", rbNoProxy:"当前活动代理不可用，请回到首页选择可用代理。",
