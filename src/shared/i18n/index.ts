...
const en = {
  ...
  disabled: "Off",
  enabling: "Applying…",
  environmentOnHint: "New apps inherit this proxy; restart apps already running.",
...
const zh: Copy = {
  ...
  proxyEnvironment: "代理环境变量", enabled: "已开启", disabled: "已关闭", enabling: "正在应用…", environmentOnHint: "新启动的应用会继承此代理地址；已运行的应用需要重启。", environmentOffHint: "未单独配置的应用将直接连接网络。",
  ...
  saveFailed: "设置保存失败", settingsLoadFailed: "无法读取已保存的设置", copyEndpoint: "复制代理地址", endpointCopied: "代理地址已复制", copyFailed: "无法复制代理地址", general: "通用", about: "关于", aboutIntro: "查看版本信息与当前更新状态。", version: "版本", updateStatus: "更新状态", updateSource: "更新来源", notChecked: "尚未检查", checkForUpdates: "检查更新", checkingUpdates: "正在检查更新…", latestVersion: "当前已是最新发布版本。", updateAvailable: "发现新版本 {version}。", noPublishedRelease: "目前还没有公开发布版本。", updateCheckFailed: "无法检查 GitHub Releases。", changelog: "更新日志", developmentPreview: "开发预览", changelogDiscovery: "自动识别本机代理客户端、实际监听端口与代理协议。", changelogVariables: "安全启停并按需管理 HTTP、HTTPS 与 ALL 代理变量。", changelogDesktop: "新增托盘控制、四种界面语言、主题与持久化窗口行为。", autoConfidence: "置信度"
};
...
const ja: Copy = {
  ...
  proxyEnvironment: "プロキシ環境変数", enabled: "オン", disabled: "オフ", enabling: "適用中…", environmentOnHint: "新規アプリに継承します。起動中のアプリは再起動してください。", environmentOffHint: "個別設定のないアプリは直接接続します。",
...
const ko: Copy = {
  ...
  proxyEnvironment: "프록시 환경 변수", enabled: "켜짐", disabled: "꺼짐", enabling: "적용 중…", environmentOnHint: "새 앱은 이 프록시를 상속합니다. 실행 중인 앱은 다시 시작하세요.", environmentOffHint: "별도 설정이 없는 앱은 직접 연결합니다.",
