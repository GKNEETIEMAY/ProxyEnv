...
const zh: Copy = {
  ...
  proxyEnvironment: "代理环境变量", enabled: "已开启", disabled: "已关闭", enabling: "正在应用…", environmentOnHint: "新启动的应用会继承此代理地址，已运行的应用需要重启才生效。", environmentOffHint: "未单独配置的应用将直接连接网络。",
...
const ja: Copy = {
  ...
  proxyEnvironment: "プロキシ環境変数", enabled: "オン", disabled: "オフ", enabling: "適用中…", environmentOnHint: "新規アプリにこのプロキシを継承。起動中のアプリは再起動後に反映。", environmentOffHint: "個別設定のないアプリは直接接続します。",
...
const ko: Copy = {
  ...
  proxyEnvironment: "프록시 환경 변수", enabled: "켜짐", disabled: "꺼짐", enabling: "적용 중…", environmentOnHint: "새 앱은 이 프록시를 상속합니다. 실행 중인 앱은 재시작 후 적용됩니다.", environmentOffHint: "별도 설정이 없는 앱은 직접 연결합니다.",
